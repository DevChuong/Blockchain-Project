...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
    ...
    if data_login_status == "Succeed":
        ...
        if choice == 2:
            ...
            answer1 = input()
            print("2/ What causes migraines?")
            answer2 = input()
            print("3/ What are the clinical manifestations of menopause?")
            answer3 = input()
        ...
        if choice == 3:
            ...
            print("Your email sender : frankwoods1243@gmail.com")
            print("Input email sender : ")
            emailSender = input()
            print("Your email receiver : 810.hoangchuong@gmail.com")
